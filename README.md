...
Smelltu á Sýna hund til að sjá random mynd af hundi.
...
The Cat API (https://api.thecatapi.com/v1/images/search) – returnar random kattamyndum sem JSON gögn, sem inniheldur url á mynd.

Dog CEO API (https://dog.ceo/api/breeds/image/random) – returnar random hundamyndum sem JSON gögn, sem inniheldur url á mynd.

Fetch API sækir frá þeim í api.js. url er fengið og notað til að sýna mynd. 
